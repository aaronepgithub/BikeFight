...
function getScores_delme() {
  ...
  $$.getJSON('https://project-5844362817932994168.firebaseio.com/scores/users.json?orderBy="fb_RND_t"&limitToLast=20',function(scores){
    ...
    //OVERALL-TODAY
    var ot_count = 0;
    var ot = _.filter(a, { 'fb_DATE_t': pubFullDate});
    ...
    _.forEach(ot1, function(value, key) {
      ...
      var ott_count = 0;
      var ot_team = _.filter(ot, { 'fb_Team': tim.timTeam});
    ...
    _.forEach(ot_team1, function(value, key) {
      ...
      //SAME AS EACH DAY, JUST ADDING A TEAM FILTER
       var otg_count = 0;
      var ot_group = _.filter(ot, { 'fb_Group': tim.timGroup});
    ...
    _.forEach(ot_group1, function(value, key) {
      ...
      //SAME AS EACH DAY, JUST ADDING A TEAM FILTER
      var ots_count = 0;
      var ot_style = _.filter(ot, { 'fb_Style': tim.timStyle});
    ...
    var oh0 = _.filter(ot, function(o) { return o.fb_TIME_h > past_hour; });
